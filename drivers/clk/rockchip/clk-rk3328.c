...
static struct rockchip_clk_branch rk3328_clk_branches[] __initdata = {
	...
	COMPOSITE_FRACMUX_PRATE(0, "clk_i2s0_frac", "clk_i2s0_div", CLK_SET_RATE_PARENT,
	...
	COMPOSITE_FRACMUX_PRATE(0, "clk_i2s1_frac", "clk_i2s1_div", CLK_SET_RATE_PARENT,
	...
	COMPOSITE_FRACMUX_PRATE(0, "clk_i2s2_frac", "clk_i2s2_div", CLK_SET_RATE_PARENT,
